...
<table>
  <tr>
    ...
    <td width="50%">
      ...
      <p align="center">
        <img src="https://img.shields.io/badge/Pathway-Junior_Analyst-00A6FB?style=flat-square&logoColor=white" />
        <br />
        <img src="https://img.shields.io/badge/Forensics-Digital-E34F26?style=flat-square" />
        <img src="https://img.shields.io/badge/Intelligence-OSINT-6E5494?style=flat-square" />
        <img src="https://img.shields.io/badge/Hunting-Threat-CC342D?style=flat-square" />
        <br />
        <img src="https://img.shields.io/badge/Analysis-Network-007A87?style=flat-square" />
        <img src="https://img.shields.io/badge/Management-Vulnerability-4B275F?style=flat-square" />
        <br />
        <img src="https://img.shields.io/badge/Ops-Dark_Web-1F2937?style=flat-square" />
        <img src="https://img.shields.io/badge/Testing-Penetration-991B1B?style=flat-square" />
      </p>
    </td>
  </tr>
</table>
...
<table>
  <tr>
    <td width="50%">
      <h3 align="center">SOC Home Lab</h3>
      <p align="center">
        <a href="https://github.com/hydr-aa/soc-home-lab">
          <img src="https://img.shields.io/badge/Wazuh-SIEM-005571?style=flat-square&logo=wazuh" />
          <img src="https://img.shields.io/badge/Sysmon-Telemetry-4B275F?style=flat-square" />
          <img src="https://img.shields.io/badge/MITRE-Mapped-red?style=flat-square" />
        </a>
      </p>
      <p align="center">Two-VM architecture running Wazuh SIEM with Sysmon telemetry, custom detection rules, and validated attack detection against the MITRE ATT&CK framework.</p>
    </td>
    <td width="50%">
      <h3 align="center">CTF Writeups</h3>
      <p align="center">
        <a href="https://github.com/hydr-aa/GMI-BTECTF25-Writeup">
          <img src="https://img.shields.io/badge/GMI-BTE_CTF_2025-blue?style=flat-square" />
        </a>
        <a href="https://github.com/hydr-aa/GMI-Kernel-CTF">
          <img src="https://img.shields.io/badge/GMI-Kernel_CTF_2025-8A2BE2?style=flat-square" />
        </a>
      </p>
      <p align="center">Detailed writeups from Break the Enigma CTF and Kernel CTF covering reverse engineering, exploitation, and forensics challenges.</p>
    </td>
  </tr>
</table>
